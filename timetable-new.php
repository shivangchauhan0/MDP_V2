    ...
    <?php 
      ...
      <div class="tt-container border">
        <div class="tt-schema">
           ...
           <div class="tt-schema__item py-4 border px-2">FIRST</div>
           <div class="tt-schema__item py-4 border px-2">SECOND</div>
           <div class="tt-schema__item py-4 border px-2">THIRD</div>
           <div class="tt-schema__item py-4 border px-2">FOURTH</div>
           <div class="tt-schema__item py-4 border px-2">FIFTH</div>
           <div class="tt-schema__item py-4 border px-2">SIXTH</div>
           <div class="tt-schema__item py-4 border px-2">SEVENTH</div>
           <div class="tt-schema__item py-4 border px-2">EIGHTH</div>
           <div class="tt-schema__item py-4 border px-2">NINTH</div>
        </div>
