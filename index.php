...
<script>
 ...
 <div id="page-content-wrapper">
        ...
        >
        <button onclick="toggleSideNav()" class="ui button bg-red small" id="menu-toggle"><i class="fa fa-bars mr-1" aria-hidden="true"></i> Menu</button>
          ...
          <?php 
           ...
           if ($comm_res->num_rows > 0) {
            while ($comm = $comm_res->fetch_assoc()) {
                    if ($comm["hod_com"] != "") {
                    echo "<tr><td colspan='10'> <span style='color:#FBBD08'>HOD &#8594; ".$comm["hod_com"]."</span></td></tr>";
                    }
                    if ($comm["dean_com"] != "") {
                    echo "<tr><td colspan='10'><span style='color:#2185D0'>DEAN &#8594; ".$comm["dean_com"]."</span></td></tr>";
                    }
                    if ($comm["principal_com"] != "") {
                    echo "<tr><td colspan='10'><span style='color:#21BA45'>PRINCIPAL &#8594; ".$comm["principal_com"]."</span></td></tr>";
                    }
                  }
                }
              }
