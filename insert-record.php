        ...
        <form method="get" action="insert-record.php" class="ui form note-form">
            <div class="fields">
                ...
                <div class="field">
                    ...
                    <button id="btn" name="submit" class="ui button bg-red" type="submit">Submit</button>
                </div>
            </div>
        </form>
       ...
       <h2 style="color:#A4243B">Enter records of <?php echo $formatted_date?> (<?php echo $dayOfWeek ?>)</h2>
        ...
        <!-- <form method="post" action="insert-record.php" class="ui form rec-form">
          <div class="fields">
            ...
            <div class="field">
              <input  readonly type="text" name="subject" value="<?php echo $table["s1"] ?>">
            </div>
            <div class="field">
              <div class="six_vw">
                <input class="my-2 mx-1" id="radio-input" name="classtype" value="Theory" type="radio"><label>T</label>
        ...
        <form method="post" action="insert-record.php" class="ui form rec-form my-3">
          <div class="fields">
            <div class="field">
            ...
            <div class="field">
              <input  readonly type="text" name="subject" value="<?php echo $table["s2"] ?>">
            </div>
            <div class="field">
              <div class="six_vw">
                <input class="my-2 mx-1" id="radio-input" name="classtype" value="Theory" type="radio"><label>T</label>
        ...
        <form method="post" action="insert-record.php" class="ui form rec-form my-3">
          <div class="fields">
            ...
            <div class="field">
              <input  readonly type="text" name="subject" value="<?php echo $table["s6"] ?>">
            </div>
            <div class="field">
              <div class="six_vw">
                <input class="my-2 mx-1" id="radio-input" name="classtype" value="Theory" type="radio"><label>T</label>
