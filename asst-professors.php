                    ...
                    while ($row = $result-> fetch_assoc())
                     if ($row['designation'] != "Hod") {
                        ...
                        <tr>
                            ...
                            <td><a href="#" style="color:#000" class="mx-1"><?php echo $row["name"] ?></a></td>
                            <td style="width:11vw">
                                <a href="#"><button type="submit" class="ui button tiny bg-red mx-1" id="insert-id">Correct <i class="fa fa-pen fa-fw ml-1" aria-hidden="true"></i></button></a> 
                            </td>
                        </tr>
                <?php	}
                     }
